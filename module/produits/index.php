...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajouter_produit'])) {
    ...
    $addQuery = $pdo->prepare("INSERT INTO produits (nom, description, prix, image) VALUES (:nom, :description, :prix, :image)");
    $addQuery->execute([
        'nom' => $nom,
...
$query = $pdo->query("SELECT * FROM produits ORDER BY date_ajout DESC");
                ...
                <tr>
                    <td>
                        <?php if (!empty($produit['image'])): ?>
                            <img src="../../<?php echo $produit['image']; ?>" alt="<?php echo $produit['nom']; ?>" class="product-image">
                        <?php else: ?>
                            N/A
                        <?php endif; ?>
                    </td>
                    ...
                    <td><?php echo $produit['date_ajout']; ?></td>
                    <td class="actions">
